...
spl_autoload_register(function ($class) {
    ...
    $nameSpace = str_replace('\\', DIRECTORY_SEPARATOR, ucfirst(strtolower($match[1])));
    $className = $match[2];
